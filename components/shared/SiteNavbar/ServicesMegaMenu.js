...
const ServicesMegaMenu = ({active}) => {
    return (
        <>
            <div className="nav-item insight-drop dropdown has-megamenu mr-0 ">
                <a className={`nav-link dropdown-toggle ${active && "active"}`} role="button" aria-expended="false" aria-haspopup="true" href="#" data-bs-toggle="dropdown">Services</a>
