            ...
            <div className={"gray-bg w-100 p-4 my-4 my-md-0 round-6 " + className}>
                <div className="d-md-flex text-center justify-content-between">
                    <div className="d-md-flex text-center align-items-center">
                        ...
                        <div>
                            <LinkedinShareButton title="Swajan" url={link}>
                                <div className="tutor-contact-icon-container linkedIn" >
                                    <div className="tutor-contact-icons">
                                        <FaLinkedinIn />
                                    </div>
                                </div>
                            </LinkedinShareButton>
                            {/* <TwitterShareButton title="Swajan" url={link}> <div className="twitter tutor-contact-icon-container" >
                                <div className="tutor-contact-icons"><FaTwitter /></div>
                            </div></TwitterShareButton> */}
                            <FacebookShareButton title="Swajan" url={link}> <div className="facebook tutor-contact-icon-container" >
                                <div className="tutor-contact-icons"><FaFacebookF /></div>
                            </div></FacebookShareButton>
                            <EmailShareButton title="Swajan" url={link}> <div className="google tutor-contact-icon-container" >
