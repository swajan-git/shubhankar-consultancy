            ...
            <main className="capital-market">
                <section className="bg-section">
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-md-8 py-5 offset-md-2 bg-white">
                        ...
                        <div className="row">
                            <div className="col-md-2 orange-top orange-right bg-transparent-blue "></div>
                            <div className="col-md-8 bg-transparent-blue py-5">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-8 bg-white pt-5">
                        ...
                        <div className="row">
                            <div className="col-md-2 orange-bottom bg-white"></div>
                            ...
                            <div className="col-md-7 bg-white">
                                ...
                                <h3 className="mb-4">Wealth Management</h3>
                                <p>
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-md-6 offset-md-2">
                                ...
                                <h3 className="mb-4">Market Infrastructure</h3>
                                <p>
                            ...
                            <div className="col-md-4 orange-top orange-left orange-bottom"></div>
                        </div>
                    </div>
                </section>
            </main>
