                ...
                <section className="bg-section">
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            ...
                            <div className="col-md-5 bg-white py-5">
                                <h3 className=" font-weight-900">
                                Safe and sustainable operations in a digital 
                                </h3>
                ...
                <section>
                    <div className="container-fluid">
                        ...
                        <div className="row ">
                            ...
                            <div className="col-md-5">
                                <h3>Expand Your Social License</h3>
                                <p>
                                ...
                                <h3 className="mb-4 mt-4">Balancing Your Operations</h3>
                                <p>
