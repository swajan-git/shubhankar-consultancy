...
const IndustriesPage = () => {
    return (
        <>
            <SEOLayout title="Pharmaceuticals & Chemicals | Shubhankar Consulting"  activeNav="industries" />
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            ...
                            <div className="col-md-6 text-white">
                                <h1 className="display-4  font-weight-900 pb-3 ">
                                    Pharmaceuticals & <br />Chemicals <span className="orangered-dot">.</span>
                                </h1>
                                <p className="font-weight-900 font-20 py-4">The future is now</p>
                                <p className="font-18 mb-4">
                                    We use innovation, transformational strategies, and digital enablement for growth, differentiation, and resilient operations by combining our chemical consulting and technology experience with the current chemical industry trends.
                                </p>
                                <p className="font-18">
                                    We're helping to change the way businesses operate, whether it's through mergers and acquisitions, streamlining factory operations, or using SAP S/4HANA for business transformation.
                                </p>
                            </div>
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="row capabilities">
                            ...
                            <div className="col-md-6 offset-md-1 pb-5">
                                ...
                                <h3 className="py-4 mt-5">Supply Chain & Operations</h3>
                                <p>
