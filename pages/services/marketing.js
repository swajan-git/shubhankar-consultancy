    ...
    return (
        ...
        <SEOLayout title="Marketing | Services" />
            <main className="marketing">
                ...
                <section className="text-section hero-bottom">
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-md-5 order-md-2">
                                <div className=" py-5 px-4 bg-transparent-dark text-white">
                                    <h1 className="display-4 mt-5 pt-5 text-white font-weight-900">
                                        Marketing <span className="orange-dot">.</span>
                                    </h1>
                                </div>
                            </div>
                            <div className="col-md-4 mkt-text offset-md-3 order-md-1 pt-5">
                ...
                <section className="we-do">
                    <div className="container-fluid">
                        <div className="row ">
                            <div className="col-md-7  p-5 topic-one">
                                <div className="row">
                                    <div className="col-md-6 offset-md-6">
                                        <div className="text-white text-md-right mt-5">
                                            <h4 className="font-bold font-26 mb-0">Recreate your Brand Narrative</h4>
                                            <p className="font-italic mb-4">Rewrite stories, Promise an experience</p>
                                            <p>
                            ...
                            <div className="col-md-5 orange-border-top py-md-5">
                                <div className="px-md-4 py-5">
                                    <h4 className="font-bold font-26 mb-4">How we do it: </h4>
                                    ...
                                    <p className="font-bold mb-1">Creativity and Innovation</p>
                                    <p className="mb-3">
                                    ...
                                    <p className="font-bold mb-1">Engagement</p>
                                    <p className="mb-0">
                        ...
                        <div className="row mt-3">
                            <div className="col-md-7  p-5 topic-two">
                                <div className="row">
                                    <div className="col-md-6 offset-md-6">
                                        <div className="text-white text-md-right mt-5">
                                            <h4 className="font-bold font-26 mb-0">Boost Brand Growth</h4>
                                            <p className="font-italic mb-4">Target Excellence, Deliver Perfection</p>
                                            <p>
                            ...
                            <div className="col-md-5 py-md-5 orange-border-top">
                                <div className="px-md-4 py-5">
                                    <h4 className="font-bold font-26 mb-4">How we do it: </h4>
                                    <p className="font-bold mb-1">Research</p>
                                    <p className="mb-3">
                                    ...
                                    <p className="font-bold mb-1">Campaigns</p>
                                    <p className="mb-0">
                        ...
                        {/* three */}
                        <div className="row mt-3">
                            <div className="col-md-7  p-5 topic-three">
                                <div className="row">
                                    <div className="col-md-6 offset-md-6">
                                        <div className="text-white text-md-right mt-5">
                                            <h4 className="font-bold font-26 mb-0">Thrive Marketing Efficiency</h4>
                                            <p className="font-italic mb-4">Remove impediments towards impact </p>
                                            <p>
                            ...
                            <div className="col-md-5 py-md-5 orange-border-top">
                                <div className="px-md-4 py-5">
                                    ...
                                    <p className="font-bold mb-1">Demand</p>
                                    <p className="mb-0">
